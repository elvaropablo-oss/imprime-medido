...
<body>
  ...
  <header class="site-header"><a class="brand" href="${base}" aria-label="ImprimeMedido, inicio"><span aria-hidden="true">▦</span> ImprimeMedido</a><nav aria-label="Principal"><a href="${base}herramientas/">Herramientas</a><a href="${base}guias/imprimir-tamano-real/">Guía</a><a href="${base}metodologia/">Metodología</a></nav></header>
