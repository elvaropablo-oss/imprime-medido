...
createServer(async (request, response) => {
  try {
    ...
    let pathname = decodeURIComponent(url.pathname).replace(/^\/imprime-medido\/?/, '');
...
}).listen(port, () => console.log(`ImprimeMedido disponible en http://localhost:${port}/imprime-medido/`));
